<template lang="html">
  <div class="home-background">
    ...
    <div class="container home">
      <svg class="logo" height="260" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 476.62 367.57"><defs><linearGradient id="logo-gradient" x1="50%" y1="0%" x2="50%" y2="100%" >
    ...
    <Footer-Section v-bind:footerdark="footerdark"
...
export default {
  ...
  mounted() {
          // TweenLite.from('.typewriter', 3, { opacity: 1})
        TweenLite.from('.logo', 2,  { opacity: 0 })
        TweenLite.to('.logo', 5,  { opacity: 1, display: 'flex' })
