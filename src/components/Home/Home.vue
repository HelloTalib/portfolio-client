    ...
    <div class="container home">
      ...
      <svg class="logo2" height="260" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 476.62 367.57"><defs><linearGradient id="logo-gradient" x1="50%" y1="0%" x2="50%" y2="100%" >
                  ...
                  <stop offset="0%" stop-color="#FF001C">
                      <animate attributeName="stop-color" values="#FF001C; #573AB2; #FF001C" dur="10s" repeatCount="indefinite"></animate>
                  </stop>

                  <stop offset="100%" stop-color="#FF001C">
                      <animate attributeName="stop-color" values="#573AB2; #FF001C; #573AB2" dur="9s" repeatCount="indefinite"></animate>
                  </stop>
...
.logo-home {
  ...
  animation: dash 7s alternate-reverse infinite;
}
